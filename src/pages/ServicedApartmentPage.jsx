...
import ServicedApartmentFilter from "../components/filters/ServicedApartmentFilter";
import ServicedApartment from "../components/propertycard/ServicedApartment";

const ServicedApartmentPage = () => {
  const navigate = useNavigate();
  const location = useLocation();
  const [activeButton, setActiveButton] = useState("Rent");
  const [activeApartmentType, setActiveApartmentType] = useState("Serviced Apartment");
        ...
        <section className="w-full h-[150px] md:h-[200px] relative flex items-center justify-center overflow-hidden group pb-6">
          ...
          <div className="max-w-none mx-auto px-6 relative z-10 text-center w-full flex flex-col items-center justify-center gap-1">
            ...
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-1 animate-slide-up drop-shadow-[0_0_30px_rgba(0,105,92,0.5)]">
              Find Your Perfect <span className="text-transparent bg-clip-text bg-gradient-to-r from-teal-300 via-emerald-300 to-teal-300 animate-gradient-text">Rental Apartment</span>
            </h1>
           
            <p className="text-base md:text-lg text-white/90 mb-2 max-w-3xl mx-auto leading-relaxed">
              Explore rental apartments with flexible terms and premium amenities
            </p>
            ...
            <div className="hidden md:block space-y-4">
              <div className="flex gap-4 items-center">
                ...
                <div className="relative flex-1 group">
                  ...
                  <input
                    type="text"
                    placeholder="Search rental apartments by city, locality, or landmark"
...
export default ServicedApartmentPage;