...
import GatedCommunityApartmentFilter from "../components/filters/GatedCommunityApartmentFilter";
import GatedCommunityApartment from "../components/propertycard/GatedCommunityApartment";

const GatedCommunityApartmentPage = () => {
  const navigate = useNavigate();
  const location = useLocation();
  const [activeButton, setActiveButton] = useState("Rent");
  const [activeApartmentType, setActiveApartmentType] = useState("GatedCommunity Apartment");
          ...
          <div className="max-w-none mx-auto px-6 relative z-10 text-center w-full flex flex-col items-center justify-center gap-1">
            <div className="mb-1 inline-flex items-center gap-2 px-3 py-1 rounded-full bg-gradient-to-r from-teal-600/20 to-emerald-600/20 backdrop-blur-lg border border-teal-300/20 animate-float-glow shadow-[0_0_30px_rgba(0,105,92,0.3)]">
              ...
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-teal-300 to-emerald-300 text-sm font-medium">
                GatedCommunity Apartment Properties
              </span>
            </div>
            ...
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-1 animate-slide-up drop-shadow-[0_0_30px_rgba(0,105,92,0.5)]">
              Find Your Perfect <span className="text-transparent bg-clip-text bg-gradient-to-r from-teal-300 via-emerald-300 to-teal-300 animate-gradient-text">GatedCommunity Apartment</span>
            </h1>
           
            <p className="text-base md:text-lg text-white/90 mb-2 max-w-3xl mx-auto leading-relaxed">
              Explore GatedCommunity apartments with flexible terms and premium amenities
            </p>
            ...
            <div className="hidden md:block space-y-4">
              <div className="flex gap-4 items-center">
                ...
                <div className="relative flex-1 group">
                  ...
                  <input
                    type="text"
                    placeholder="Search GatedCommunity apartments by city, locality, or landmark"
...
export default GatedCommunityApartmentPage;